                    ...
                    <fieldset class="fieldset">
                        ...
                        <div class="fieldsetDiv">
                            <table class="table-bordered" width="99%" align="center">
                                <tr>
                                    <th class="TextAlignLeft">Job Title
                                    </th>
                                    <th class="TextAlignCenter">Location
                                    </th>
                                    <th class="TextAlignRight">Salary
                                    </th>
                                    <th class="TextAlignRight">Deadline
                                    </th>
                                    <th></th>
                                </tr>
                                <tbody>
                                ...
                                <tr>
                                    <td class="TextAlignLeft">
                                        Psychosocial Specialist, Psychosocial Counseling Unit, HR & Learning Division (Contractual)
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-mini" href="#" target="_blank">
                                ...
                                <tr>
                                    <td class="TextAlignLeft">
                                        Deputy Manager, Marketing, Skills Development Programme (Contractual)
                                    </td>
                                    <td class="TextAlignCenter">
                                        BRAC-ISD, Dhaka
                                    </td>
                                ...
                                <tr>
                                    <td class="TextAlignLeft">
                                        Team Lead, Communications (Contractual); Humanitarian Crisis Management Programme
                                    </td>
                                    <td class="TextAlignCenter">
                                        Cox's Bazar
                                    </td>
                                ...
                                <tr>
                                    <td class="TextAlignLeft">
                                        Innovation Ecosystem and Partnerships Manager , Social Innovation Lab (Contractual)
                                    </td>
                                    <td class="TextAlignCenter">
                                        BRAC Head Office
                                    </td>
