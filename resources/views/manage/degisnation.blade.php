                    ...
                    <table id="designationtable" class="table table-striped table-bordered" style="width:100%" >
                        ...
                        @foreach($degisnation as $d)
                            <tr>
                                ...
                                <td width="10%"><button class="btn btn-sm btn-success" data-panel-id="{{$d->designationId}}" onclick="editDegisnation(this)">Edit</button>
                                </td>
...
@section('foot-js')
    ...
    <script>
        ...
        function editDegisnation(x) {
            ...
            $.ajax({
                type: 'POST',
                url: "{!! route('admin.editDegisnation') !!}",
                cache: false,
