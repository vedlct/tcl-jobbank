...
//            $add_data->interviewCallDateTime = $intviewTime;
            ...
            try{
                $pdf = PDF::loadView('mail.interviewCard',['empInfo' => $employeeInfo,'footerAndSign'=>$footerAndSign,'subjectLine'=>$subjectLine,'jobInfo'=>$jobInfo]);
